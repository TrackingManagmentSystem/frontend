...
// export const getStatusLabel = ({ status, subStatus }: Status) => {
  // const statusLabel = statusTranslations[status as StatusType] || "Desconhecido";
  // const subStatusLabel = subStatus ? statusTranslations[subStatus as StatusType] : undefined;
